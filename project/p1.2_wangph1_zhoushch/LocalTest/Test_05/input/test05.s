...
main:
    ...
    ### TODO: YOUR CODE HERE ###
    la a1, square # Load the address of the "square" function into a1
    ...
    ### TODO: YOUR CODE HERE ###
    la a1, decrement # Load the address of the "decrement" function into a1
...
print_me_and_recurse:
    ...
    ecall
    addi a1, x0, 32   # a0 gets address of string containing space
